...
var ImageSize;
(function (ImageSize) {
    ImageSize[ImageSize["xsmall"] = 0] = "xsmall";
    ImageSize[ImageSize["small"] = 1] = "small";
    ImageSize[ImageSize["medium"] = 2] = "medium";
    ImageSize[ImageSize["large"] = 3] = "large";
    ImageSize[ImageSize["xLarge"] = 4] = "xLarge";
})(ImageSize || (ImageSize = {}));
var AmazonProductImage = (function () {
    function AmazonProductImage(uri, height, width, size) {
    }
    return AmazonProductImage;
}());
var AmazonProduct = (function () {
    function AmazonProduct(productPayload) {
        link =
        ;
    }
    AmazonProduct.prototype.pid = function () {
        function s4() {
