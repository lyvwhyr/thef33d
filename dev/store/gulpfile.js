...
// Bundle
gulp.task('bundle', ['styles', 'typescript', 'scripts', 'bower'], function() {
    return gulp.src('./app/*.html')
        .pipe($.useref.assets())
        .pipe($.useref.restore())
        .pipe($.useref())
...
// Watch
gulp.task('watch', ['html', 'fonts', 'typescript', 'bundle'], function() {
...
// Build
gulp.task('build', ['html', 'typescript', 'buildBundle', 'images', 'fonts', 'extras'], function() {
